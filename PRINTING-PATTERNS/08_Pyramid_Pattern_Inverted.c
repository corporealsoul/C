...
printf("\n");
    ...
    for (size_t first_outer_loop = 0; first_outer_loop < count; first_outer_loop++)
    {
        ...
        for (size_t first_inner_loop_two = count - first_outer_loop; first_inner_loop_two > 0; first_inner_loop_two--)
        {
            printf("* ");
        }
        for (size_t first_inner_loop_three = count - first_outer_loop; first_inner_loop_three > 1; first_inner_loop_three--)
        {
            printf("* ");
        }
        printf("\n");
